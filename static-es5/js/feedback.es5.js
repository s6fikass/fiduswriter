...
var FeedbackTab = exports.FeedbackTab = function () {
    function FeedbackTab() {
        _classCallCheck(this, FeedbackTab);

        this.speed = 300;
        this.bind();
    }

    _createClass(FeedbackTab, [{
        key: "bind",
        value: function bind() {
            var _this = this;
            ...
            jQuery('a.feedback-tab').click(function (event) {
                if (!jQuery('.feedback-panel').hasClass('open')) {
                    jQuery('.feedback-panel').stop().fadeIn(_this.speed, function () {
            ...
            jQuery('#closeFeedback').click(function () {
                jQuery('.feedback-panel').stop().fadeOut(_this.speed, function () {
            ...
            if ((!(bowser.chrome || bowser.firefox || bowser.msedge || bowser.safari) || bowser.mobile || bowser.tablet) & !(0, _common.getCookie)('browsercheck')) {
                ...
                jQuery("<div>" + warning + "</div>").dialog({
                    ...
                    create: function create() {
                        jQuery(this).closest(".ui-dialog").find(".ui-dialog-buttonpane .ui-button:first").addClass("fw-button fw-orange");
                    }
                });
            }
        }
...
},{"../common":1,"bowser/bowser":4}],3:[function(require,module,exports){
"use strict";

var _feedback = require("./es6_modules/feedback");

window.theFeedbackTab = new _feedback.FeedbackTab();

},{"./es6_modules/feedback":2}],4:[function(require,module,exports){
/*!
