...
export let PDFFileCreator = function(latexCode, ImagesList,externalClass, title) {
    compile(latexCode,ImagesList,externalClass,title);
    }
...
var compile = function(source_code,ImagesList,externalClass,pdfFiletitle) {
        ...
        pdftex.set_TOTAL_MEMORY(80*2048*2048).then(function() {
            ...
            if(externalClass){
                pdftex.FS_createPath('/', 'class', /*canRead=*/true, /*canWrite=*/true).then(function() {
                    pdftex.FS_createLazyFile('/', externalClass.split('/')[4], externalClass, true, true);
