...
var _require$commands = require("../edit").commands,
    undo = _require$commands.undo,
    redo = _require$commands.redo,
    lift = _require$commands.lift,
    joinUp = _require$commands.joinUp,
    selectParentNode = _require$commands.selectParentNode,
    wrapIn = _require$commands.wrapIn,
    setBlockType = _require$commands.setBlockType,
    wrapInList = _require$commands.wrapInList,
    toggleMark = _require$commands.toggleMark;

var _require2 = require("../util/obj"),
    copyObj = _require2.copyObj;

var _require3 = require("./icons"),
    getIcon = _require3.getIcon;
